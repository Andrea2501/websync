...
class BuilderTableUpdateTecnotradeWebsyncClientPropvaluefieldPropvaluerule2 extends Migration
{
    public function up()
    {
        Schema::table('tecnotrade_websync_client_propvaluefield_propvaluerule', function($table)
        {
            ...
            $table->renameColumn('client_provalues_rules_id', 'client_prop_value_rules_id');
    ...
    public function down()
    {
        Schema::table('tecnotrade_websync_client_propvaluefield_propvaluerule', function($table)
        {
            ...
            $table->renameColumn('client_prop_value_rules_id', 'client_provalues_rules_id');
